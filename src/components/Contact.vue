      ...
      contactInfo: [
        {
          icon: "email",
          label: "Email",
          value: "afifahsalwa@email.com",
          href: "mailto:afifahsalwa@email.com",
        },
        {
          icon: "location",
          label: "Lokasi",
        ...
        },
        {
          icon: "linkedin",
          label: "LinkedIn",
          value: "linkedin.com/in/afifahsalwa",
          href: "https://linkedin.com/in/afifahsalwa",
        },
        {
          icon: "github",
          label: "GitHub",
          value: "github.com/afifahsalwa",
          href: "https://github.com/afifahsalwa",
        },
      ],
    };
  },
...
<template>
  ...
  >
    ...
    <div
      class="absolute left-0 w-72 h-72 bg-emerald-100/50 rounded-full blur-3xl -translate-x-1/2 pointer-events-none"
    ></div>
    ...
    <div class="max-w-7xl mx-auto relative">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div class="lg:col-span-5 space-y-6">
          ...
          <div
            class="flex items-center gap-3 px-5 py-4 bg-emerald-50 border border-emerald-100 rounded-xl"
          >
            <span
              class="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-ping flex-shrink-0"
            ></span>
            ...
            <form @submit.prevent="handleSubmit" class="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="5"
                  placeholder="Halo Afifah, saya ingin berdiskusi tentang..."
                  required
                  class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-slate-800 text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-transparent focus:bg-white transition-all duration-200 resize-none"
                ></textarea>
              </div>
